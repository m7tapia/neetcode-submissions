class Solution:
    ...
    #we find this by starting our first window. it'll cover from 0 to k and then we can shift our window
    #forward one index n - k times after that. If you want to be precise you can add the 1 for the first window 
    #but it doesn't rlly change much.
