...
class Solution:
    def maxSlidingWindow(self, nums: List[int], k: int) -> List[int]:
        ...
        #When we append to the end (to the right), we check if there are older numbers (to the left) that are smaller.
        ...
        #else, if our new number is smaller, we append b/c rn its not the max but when the bigger numbers are out of the window
