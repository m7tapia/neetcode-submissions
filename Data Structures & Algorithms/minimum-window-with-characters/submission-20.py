class Solution:
    #using a variable matched to keep track of how many of our keys in 
    #window_freq are greater than or equal to what we need. this
    #is the most optimal. Slightly less optimal but still O(n) next solution.
