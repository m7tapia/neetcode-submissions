class Solution:
    def dailyTemperatures(self, temperatures: List[int]) -> List[int]:
        ...
        #The stack will always end non empty. The last index doesn't have a temp greater than it and 
        #other temps may also not have a temp greater than it. But since we intialized all indices to
        #be 0 at the start, that's already handled.
