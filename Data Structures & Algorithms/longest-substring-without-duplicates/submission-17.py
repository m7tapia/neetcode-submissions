class Solution:
    def lengthOfLongestSubstring(self, s: str) -> int:
        ...
        #This way is using the set and checking its length instead of using the in operator
        #Slightly more complicated but it was my first instinct so useful to know this way too.

        #O(n) time and and O(n) space